...
function Dashboard() {
    ...
    return (
        <>
            <Secured />
            <MainHeader notification={notification} onHandleNotification={notificationHandled} />

            <div className="container-fluid pl-0 pr-0" style={{ backgroundColor: '#f2f3f8' }} >
                <div className="wrapper">
                    <Sidebar />
                    <MainContent notification={notification} onHandleNotification={notificationHandled}/>

                </div>
            </div>


<div >  <center> <h2> Footer .....</h2> </center> </div>        </>
    )
}
