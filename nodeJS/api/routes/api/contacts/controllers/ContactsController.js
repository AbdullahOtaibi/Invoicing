...
router.post("/search/", verifyToken, async (req, res) => {
  ...
  try {
    ...
    console.log( contactTypeVal , " :contactTypeVal" + contactTypeVal.toString()  + ", :contactTypeVal length" + contactTypeVal.length + " text val:" + val) 
    if(contactTypeVal.length <=0 )
    {
